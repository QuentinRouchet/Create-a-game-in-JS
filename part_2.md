...
To make the doodler move from one side to another we need two conditions inside of the `doodler` object. Within the `update` function, in the `doodler` object, add this:
